/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 64ae68fba6f36ce042af2038076f8e81)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_VERSION" | "ENVIRONMENT" | "CORS_ORIGINS" | "PUBLIC_SITE_ORIGIN" | "INVITE_FROM_EMAIL" | "INVITE_FROM_NAME" | "INVITE_REPLY_TO" | "MAILGUN_DOMAIN" | "SIGNUP_FROM_EMAIL" | "SIGNUP_FROM_NAME" | "SIGNUP_REPLY_TO" | "TURNSTILE_EXPECTED_ACTION" | "TURNSTILE_EXPECTED_HOSTNAMES">> {}
}
